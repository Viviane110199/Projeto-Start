		...
		void exibirMenuLogin() {
			do {
				...
				case '2':
					...
					break;
				case '3':
					System.out.println("A Start é um aplicativo focado em facilitar e transformar a sua experiência pós formatura, pois,");
					System.out.println("sabemos o quão importante e marcante esse momento é na vida dos formandos, seja no ensino médio ou superior.");
					break;
				case '4':
